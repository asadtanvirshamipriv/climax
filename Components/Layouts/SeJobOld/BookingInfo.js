  ...
  <>
    ...
    <Row>
      ...
      <div className='my-4'></div>
        <CheckGroupComp register={register} name='transportCheck' control={control} label='' disabled={approved}
          options={[{ label:"Transport", value:"Transport" }]} />
        <SelectSearchComp register={register} name='transporterId' control={control} label='' 
          options={state.fields.vendor.transporter} disabled={approved || transportCheck[0]!='Transport'} />
        <div className='mt-2'></div>
        <CheckGroupComp register={register} name='customCheck' control={control} label='' disabled={approved}
        ...
        <SelectSearchComp register={register} name='customAgentId' control={control} label=''
          options={state.fields.vendor.chaChb} disabled={approved || customCheck[0]!='Custom Clearance'} />
